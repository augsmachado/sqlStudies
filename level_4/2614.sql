/*
  Name: Problem 2614
	...
	Comment language: en
	Description:
		The video store is making its semi-annual report and needs your help. All you have to do is select the
			name of the clients and the date of rental, from the rentals made in September 2016.
*/
...
BETWEEN date('2016-09-01') and date('2016-09-30');
